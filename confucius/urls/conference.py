...
from confucius.views import ConferenceToggleView, ConferenceUpdateView, MembershipListView, EditAlert, CreateAlert
...
urlpatterns = patterns('confucius.views',
    ...
    url(r'^create_alert/(?P<conference_pk>\d+)/$', CreateAlert.as_view(), name='create_alert'),
